...
@Entity
@Table(name = "VW_SIGNATORY_INFO")
public class SignatoryInfoView{
	@Id
	@Column(name = "ID_SIGNATORY_KEY")
	private Long signatoryId;

	@Column(name = "TX_NAME", length = 32)
	private String name;
...
//    private String departmentName;
	...
	@Transient
	List<SignatoryInfoView> allSignatory;
	...
	public SignatoryInfoView() {
		// TODO Auto-generated constructor stub
	}

	public SignatoryInfoView(SignatureInfo dbSg) {
		// TODO Auto-generated constructor stub
		if(dbSg != null) {
			employeeId = dbSg.getEmployeeId();
			name = dbSg.getName();
			designation = dbSg.getDeligation();
	...
	public List<SignatoryInfoView> getAllSignatory() {
		return allSignatory;
	}

	public void setAllSignatory(List<SignatoryInfoView> allSignatory) {
