...
public class User extends BaseEntity{
    ...
    @SequenceGenerator(sequenceName = "USER_SEQUENCE", allocationSize = 1, name = "USER_SEQ_GEN") //for oracle
	...
	@Column(name = "TX_USER_BLOCK_CAUSE", length =256)
	private String userBlockCause;
	
	@Column(name = "TX_REJECT_CAUSE", length =256)
	...
	@Column(name = "int_old_allow")
	private Integer oldAllowLogin;
	...
	public Integer getOldAllowLogin() {
		return oldAllowLogin;
	}
	public void setOldAllowLogin(Integer oldAllowLogin) {
		this.oldAllowLogin = oldAllowLogin;
	}
