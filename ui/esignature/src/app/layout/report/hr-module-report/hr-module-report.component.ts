...
@Component({
  selector: 'app-hr-module-report',
  templateUrl: './hr-module-report.component.html',
  styleUrls: ['./hr-module-report.component.scss']
})
export class HrModuleReportComponent extends Softcafe implements OnInit, Service, AfterViewInit {
  ...
  prepareGrid() {
    ...
    this.columnDefinitions = [
      ...
      {
        id: 'pa', name: 'PA Number', field: 'pa',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 120
      },
      {
        id: 'paHolderName', name: 'PA Holder Name', field: 'paHolderName',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 170
      },
      // {
      //   id: 'hrModuleKey', name: 'HR Module Key', field: 'hrModuleKey',
      //   sortable: true, type: FieldType.number,
      //   filterable: true, filter: { model: Filters.inputText, },
      //   minWidth: 120
      // },
      // {
      //   id: 'signatoryKey', name: 'Signature Key', field: 'signatoryKey',
      //   sortable: true, type: FieldType.number, filterable: true, filter: { model: Filters.inputText, },
      //   minWidth: 150
      // },
      // {
      //   id: 'hrMakerKey', name: 'HR Maker Key', field: 'hrMakerKey',
      //   sortable: true, type: FieldType.number,
      //   filterable: true, filter: { model: Filters.inputText, },
      //   minWidth: 150
      // },
      ...
      // },
      // {
      //   id: 'hrCheckerKey', name: 'HR Checker Key', field: 'hrCheckerKey',
      //   sortable: true, type: FieldType.number,
      //   filterable: true, filter: { model: Filters.inputText, },
      //   minWidth: 180,
      // },
      ...
      {
        id: 'hrMakerName', name: 'HR Maker Name', field: 'hrMakerName',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180,
      },
      {
        id: 'hrCheckerName', name: 'HR Checker Name', field: 'hrCheckerName',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180,
      },
      {
        id: 'paCreateDate', name: 'PA Create Date', field: 'paCreateDate',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180
      },
      {
        id: 'agreementFile', name: 'Agreement File Date', field: 'agreementFile',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180,
      },
      {
        id: 'approverFile', name: 'Approval File Date', field: 'approverFile',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180,
      },
      {
        id: 'cancelFile', name: 'Cancel Circular', field: 'cancelFile',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180,
      },
      {
        id: 'cancelCircularDate', name: ' Cancel Circular Date', field: 'cancelCircularDate',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 180,
      },
      {
        id: 'cancelCaause', name: 'Reason of Cancellation', field: 'cancelCaause',
        sortable: true, type: FieldType.text,
        filterable: isFilterable, filter: { model: Filters.inputText, },
        minWidth: 220,
      },
  ...
  buildGridOptions() {
    ...
    var option: GridOption = {
      datasetIdPropertyName: "hrModuleKey",
  ...
  loadData(fromDate, toDate, pointer) {
    ...
    this.cs.execute(ActionType.ACTION_HR_MODULE_SEARCH_REPORT, ContentType.ReportSearch, payload)
      .subscribe((res: any) => {
        console.log(res)
        debugger
        this.searchReport = res.payload.itemsHrModuleReport.map(item => ({
          ...item,
          pointer: pointer
        }));
